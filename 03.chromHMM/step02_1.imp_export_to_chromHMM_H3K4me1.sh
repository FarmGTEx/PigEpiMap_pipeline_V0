#!/bin/bash
#DSUB -n step02_imp_binarize_H3K4me1
#DSUB -A root.kkbkvxu5
#DSUB -R cpu=1;mem=6000
#DSUB -eo tmp/step02_imp_binarize_H3K4me1_%J.err
#DSUB -oo tmp/step02_imp_binarize_H3K4me1_%J.log
...
java -mx6000M -jar ${impute} ExportToChromHMM -g 2.0675 ${output_dir} imp_sampleInfo_${mark}.txt \
