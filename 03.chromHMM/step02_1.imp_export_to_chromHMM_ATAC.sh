#!/bin/bash
#DSUB -n step02_imp_binarize_ATAC
#DSUB -A root.kkbkvxu5
#DSUB -R cpu=1;mem=6000
#DSUB -eo tmp/step02_imp_binarize_ATAC_%J.err
#DSUB -oo tmp/step02_imp_binarize_ATAC_%J.log
...
java -mx6000M -jar ${impute} ExportToChromHMM -g 1.8725 ${output_dir} imp_sampleInfo_${mark}.txt \
