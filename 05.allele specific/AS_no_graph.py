...
def main():
    ...
    SNP_genotype_prefix = 'pig11_chr18'
    hisat2_genome_index_prefix = '/public/home/jwdou/05Analysis/imputation/non_graph/hisat2_index_non_graph.pig11_chr18'
...
#     run_cmd_time(cmd)
    ...
    # paired-end data
    output_path = f'{args.output}/AS/{bn}'
 ...
 -V {args.vcf} -O {output_path}/{bn}.count_result.txt'
    run_cmd_time(cmd) 
    
    
    cmd = f'{samtools} view -h -b -L merged.E4.bed {output_path}/{bn}.sorted.bam > {output_path}/{bn}.sorted.E4.bam'
    run_cmd_time(cmd) 
